        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1 space-y-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-bold text-slate-800 text-lg mb-1">Lokasi</h3>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-bold text-slate-800 text-lg mb-1">Telepon</h3>
          ...
          <div className="lg:col-span-2 bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="w-full sm:w-auto px-8 py-3 bg-blue-600 text-white font-medium rounded-xl hover:bg-blue-700 transition-colors flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed shadow-lg shadow-blue-200"
              >
